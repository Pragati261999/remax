        ...
        <div class="row">
          ...
          <div class="col-2">
            <small class="font-weight-bold">
              <img src="/assets/images/icons/bookmark_blue.png" alt="" />
            </small>
          </div>
        </div>
      </div>
            ...
            <li class="float-end">
              <small class="pe-3"
                ><img
                  ...
                  width="16px"
                />
                <span class="count card-title"> {{ property.Rms }}</span>
              </small>
            </li>
            <li class="float-end">
              <small class="pe-3"
                ><img src="/assets/images/icons/bed.png" alt="" width="16px" />
                <span class="count card-title"> {{ property.Bath_tot }}</span>
              </small>
            </li>
          </ul>
        </div>
