    ...
    <div class="container">
        <div class="row">
            <div class="col-12 mb-5 py-4">
                <h2 class="text-color mt-5 text-uppercase">Privacy Policy</h2>
                <p class="mt-3">
                ...
                <h5 class="mt-5 fw-bold theme-text">Personal Information</h5>
                <p class="mt-2">
                ...
                <h5 class="mt-5 fw-bold theme-text">
                ...
                <h5 class="mt-5 fw-bold theme-text">Email links</h5>
                <p class="mt-2">
                ...
                <h5 class="mt-5 fw-bold theme-text">Do we use ‘cookies’?</h5>
                <p class="mt-2">
                ...
                <h1 class="large-text">1. GOOGLE ANALYTICS</h1>
                <p class="mt-2">
                ...
                <h1 class="large-text">2. GOOGLE ADWORDS</h1>
                <p class="mt-2">
                ...
                <h5 class="mt-5 fw-bold theme-text">Third Party Disclosure</h5>
                <p class="mt-2">
                ...
                <p class="mt-2">We collect your email address in order to:</p>
                <ul>
                    <li>
                        <p>
                ...
                <ul>
                    ...
                    <li><p>Honor opt-out/unsubscribe requests quickly</p></li>
                    <li>
                        <p>
                ...
                <h5 class="mt-5 fw-bold theme-text">Opt-Out</h5>
                <p class="mt-2">
                ...
                <h5 class="mt-5 fw-bold theme-text">Notification of Changes</h5>
                <p class="mt-2">
                ...
                <h5 class="mt-5 fw-bold theme-text">Legal Disclaimer</h5>
                <p class="mt-2">
                ...
                <h5 class="mt-5 fw-bold theme-text">Contacting Us</h5>
                <p class="mt-2">
