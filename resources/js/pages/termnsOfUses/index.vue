    ...
    <div class="container">
        <div class="row">
            <div class="col-12 mb-5 py-4">
                <h2 class="text-color mt-5">TERMS OF SERVICE</h2>
                <p class="mt-3">
                ...
                <h5 class="mt-5 fw-bold theme-text">Disclaimer</h5>
                <p>
                ...
                <p class="mt-2">
                    ...
                    <strong>RE/MAX MILLENNIUM REAL ESTATE Brokerage</strong> who
                ...
                <p class="mt-2">
                    ...
                    <strong>RE/MAX MILLENNIUM REAL ESTATE Brokerage</strong> and
                ...
                <p class="mt-2">
                    ...
                    control of
                    <strong>RE/MAX MILLENNIUM REAL ESTATE Brokerage</strong>. We
                ...
                <p class="mt-2">
                    ...
                    smoothly. However,
                    <strong>RE/MAX MILLENNIUM REAL ESTATE Brokerage</strong>
