<template>
    <div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 text-center mt-4">
                                        ...
                                        >
                                            ...
                                            <h6 class="text-color mt-3">
                                                Brand Power
                                            </h6>
                                            <p class="text-color card-text">
        ...
        <div class="container">
            <div class="col-12 py-5">
                <div class="head text-center">
                    <h2 class="text-color fw-bold">WHAT WE STAND FOR</h2>
                    <span>We provide full support at every step.</span>
                </div>
...
.about-card:hover .card-img.hover {
    display: block;
}

.about-card:hover .card-img.not-hover {
    display: none;
}
